...
export const toggleLikeBtn = isLiked => { 
    ...
    const elem = document.querySelector('.recipe__love use').setAttribute('href', `img/icons.svg#${iconString}`);
};

export const toggleLikeMenu = numLikes => { 
    DOMelements.likesField.style.visibility = numLikes > 0 ? 'visible' : 'hidden';
};
